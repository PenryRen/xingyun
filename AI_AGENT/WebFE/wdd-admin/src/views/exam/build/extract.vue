        ...
        <el-form :model="form.buildConfig.extract" ref="extractForm" label-width="110px"
          ...
          <el-form-item label="题目分类：">
            <tree-select v-model="form.buildConfig.extract.questionArchiveIdList"
                         ...
                         :clearable="true"
                         placeholder="题目分类" style="width: 100%" clearable/>
          </el-form-item>
        ...
        <el-form :model="form" ref="form" label-width="100px" v-loading="formLoading" :rules="rules">
          ...
          <el-form-item label="考试范围：" prop="rangeType" required>
            <el-select v-model="form.rangeType" @change="rangeTypeChange" clearable>
              <el-option v-for="item in EnumMap.exam.build.rangeTypeEnum" :key="item.key"
                         :value="item.key"
          ...
          <el-form-item label="考试报名：" class="tree-select-contain"
            ...
            <div class="apply-user">
              <el-tag @close="removeApply()" v-if="null !== form.buildConfig.examPaperApplySelect"
                      closable>
          ...
          <el-form-item label="考试时间：" v-if="form.rangeType !== null && form.rangeType === 2"
            ...
            <el-date-picker v-model="form.limitDateTime" value-format="YYYY-MM-DD HH:mm:ss"
                            type="datetimerange"
                            range-separator="至" start-placeholder="考试开始时间"
          ...
          <el-form-item>
            ...
            <el-tooltip content="离开试卷超过多次会自动提交试卷">
              <div class="exam-paper-cheat-div">
                ...
                <el-input-number v-model="form.buildConfig.maxCheatCount" placeholder="防作弊次数"
                                 :step="1" :max="99"
                                 :min="1"
