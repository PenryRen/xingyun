...
try:
    ...
    create_student = None
    create_learning_profile = None
    update_learning_profile = None
    get_learning_profile = None
    get_student_exams = None
    get_student_knowledge_progress = None
    update_knowledge_progress = None
    model_to_dict = None
...
if tool:
    ...
    # 如果 tool 不可用，定义空函数
    def create_student_profile(*args, **kwargs):
        return "工具不可用"
    
    def update_learning_profile(*args, **kwargs):
        return "工具不可用"
    
    def get_student_learning_profile(*args, **kwargs):
        return "工具不可用"
    
    def update_knowledge_progress(*args, **kwargs):
        return "工具不可用"
    
    def get_knowledge_progress(*args, **kwargs):
        return "工具不可用"
