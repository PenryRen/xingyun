...
public class AnnouncementServiceImpl extends ServiceImpl<AnnouncementMapper, Announcement> implements AnnouncementService {
    ...
    @Override
    public AnnouncementArchive getAnnouncementArchiveById(Integer id) {
        return announcementArchiveMapper.selectById(id);
    }

    @Override
    public List<AnnouncementArchive> getAnnouncementArchiveByLevel(String level) {
        return announcementArchiveMapper.getAnnouncementArchiveByLevel(level);
    }
