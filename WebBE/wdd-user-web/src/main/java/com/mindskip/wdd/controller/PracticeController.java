...
public class PracticeController extends BaseApiController {
     ...
     */
    @PostMapping("/submit")
    public RestResponse answerSubmit(@RequestBody EncryptKV encryptKV) {
        ExamPaperAnswerFrame examPaperAnswerFrame = systemService.pairOneObjectDecrypt(encryptKV, ExamPaperAnswerFrame.class);
        User user = getCurrentUser();
    ...
    public RestResponse read(@PathVariable Long id) {
        ...
        return systemService.pairTwoObjectEncrypt(examPaperAnswerEditResponseVM);
    }
     ...
     */
    @PostMapping("/edit")
    public RestResponse edit(@RequestBody EncryptKV encryptKV) {
        ExamPaperAnswerInfoResponseVM examPaperAnswerRequestVM = systemService.pairOneObjectDecrypt(encryptKV, ExamPaperAnswerInfoResponseVM.class);
