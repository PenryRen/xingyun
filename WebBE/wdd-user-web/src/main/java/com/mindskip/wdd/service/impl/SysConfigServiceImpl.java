...
import com.mindskip.wdd.constant.UserConstants;
import com.mindskip.wdd.domain.ueit.SysConfig;
import com.mindskip.wdd.exception.ServiceException;
...
public class SysConfigServiceImpl implements SysConfigService {
    ...
    private String getCacheKey(String configKey) {
        return CacheKeyPrefix.simple().compute(CacheConstants.SYS_CONFIG_KEY) + configKey;
    }
}
