...
public class ExamUtil {
    public static final Integer ItemOrderInit = 10;
     ...
     * 毫秒转为时间段
     *
     * @param minSecond the min second
     * @return the string
     */
    public static String minSecondToVM(long minSecond) {
        return secondToVM((int) minSecond / 1000);
    }
