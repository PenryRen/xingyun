...
public class UserWebMybatisPlusGenerator {
    public static void main(String[] args) {
        String outDir = "D://MINDSKIP//ueit//background//ueit//ueit-user-web//src//main//";
        FastAutoGenerator.create("jdbc:mysql://192.168.0.96:3306/wdd?useSSL=false&useUnicode=true&serverTimezone=Asia/Shanghai&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&allowPublicKeyRetrieval=true&allowMultiQueries=true", "root", "123456").globalConfig(builder -> {
            ...
            builder = builder.addInclude("t_practice_exam_paper_answer");
            builder = builder.addInclude("t_practice_exam_paper_answer_json");
          /*  builder = builder.addInclude("t_user_apply");*/
