          ...
          <div class="paper-item-order-content">
            ...
            <div v-for="(tItem,tIndex) in paper.examPaperDoTitleList" :key="tIndex">
              ...
              <div class="wdd-question-anchor">
                ...
                <el-tag v-if="qItem.questionType === 7" :type="questionDoRightTag(answer.questionAnswerFrameList[qItem.itemOrder-1].doCheck)"
                        class="do-exam-title-tag"
                        @click="goAnchor(`#question-${qItem.itemOrder}`)">{{ qItem.itemOrder }}</el-tag>
                <el-tag v-else :type="questionDoRightTag(answer.questionAnswerFrameList[qItem.itemOrder-1].doRight)"
                        class="do-exam-title-tag"
                        @click="goAnchor(`#question-${qItem.itemOrder}`)">{{ qItem.itemOrder }}</el-tag>
                </span>
              </div>
