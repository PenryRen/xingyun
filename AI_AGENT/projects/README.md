...
> 重要：考试查询、统计、学情档案已迁移到 WebBE 对本地 MySQL 的认证访问。
> Agent 不再连接 Supabase，也不注册考试分析、学情 CRUD 或智能组卷工具。
> 本文件后续保留的旧 Supabase/工具示例仅为历史记录，不可用于当前运行或新开发。
...
```plaintext
你好，我是学生张三，学号2024001。请帮我创建一个学生档案。
```
