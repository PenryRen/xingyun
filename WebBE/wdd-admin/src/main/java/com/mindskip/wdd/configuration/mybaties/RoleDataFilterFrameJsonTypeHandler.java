...
public class RoleDataFilterFrameJsonTypeHandler extends BaseJsonTypeHandler {

    @Override
    public Object getNullableResult(ResultSet resultSet, String s) throws SQLException {
        return JsonUtil.toJsonObject(resultSet.getString(s), RoleDataFilterFrame.class);
    }
