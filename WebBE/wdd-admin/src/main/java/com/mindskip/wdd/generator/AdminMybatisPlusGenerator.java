...
public class AdminMybatisPlusGenerator {
    public static void main(String[] args) {
        ...
        FastAutoGenerator.create("jdbc:mysql://192.168.0.96:3306/ueit?useSSL=false&useUnicode=true&serverTimezone=Asia/Shanghai&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&allowPublicKeyRetrieval=true&allowMultiQueries=true", "root", "123456").globalConfig(builder -> {
           ...
           /* builder = builder.addInclude("t_apply");*/
          /*  builder = builder.addInclude("t_practice_build");*/
/*            builder = builder.addInclude("t_practice_exam_paper");
            builder = builder.addInclude("t_practice_exam_paper_json");*/

            builder = builder.addInclude("t_exam_paper");
            builder = builder.addInclude("t_exam_paper_child");
